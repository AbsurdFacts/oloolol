...
if isfolder("Nebula") == false then
	makefolder("Nebula")
end
if not betterisfile("Nebula/Whitelist.txt") then
	writefile("Nebula/Whitelist.txt", "{game.Players.LocalPlayer.Name}")
end
...
local Nebula = GuiLibrary.CreateWindow({
	["Name"] = "Nebula", 
...
GUI.CreateButton({
	["Name"] = "Nebula", 
	["Function"] = function(callback) Nebula.SetVisible(callback) end, 
	["Icon"] = "vape/assets/PinButton.png", 
	["IconSize"] = 16,
})
GUI.CreateDivider("Nebula Client")
...
local tabcategorycolor = {
	...
	["NebulaWindow"] = Color3.fromRGB(0, 255, 255)
}
